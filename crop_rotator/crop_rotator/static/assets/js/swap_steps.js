$(document).ready(function()
{
  $("button[name='move_plan']").click(function(event)
 {
  ...
  var receiver_order = button_triger.closest(".master0").nextAll(".slave0").first().children().first().children("option:selected").attr('value');
  var receiver_id = button_triger.closest(".master0").nextAll(".slave0").first().children().first().children("option:selected").attr('name');
